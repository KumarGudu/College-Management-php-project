...
echo '<h4><a href="teacher.html">Add Teacher</a> | <a href="home.html">Back</a></h4><br>';
// Check connection
		...
		$sql = "SELECT id, teacher_name, regd_no, mobile_no, department_name, gender FROM teacher";
		    ...
		    while($row = $result->fetch_assoc())
		     {
				...
				echo '<td><b><font color="#663300">' . $row['teacher_name'] . '</font></b></td>';
				...
				echo '<td><b><font color="#663300"><a href="teacheredit.php?id=' . $row['id'] . '">Edit</a></font></b></td>';
				echo '<td><b><font color="#663300"><a href="teacherdelete.php?id=' . $row['id'] . '">Delete</a></font></b></td>';
				echo "</tr>";
