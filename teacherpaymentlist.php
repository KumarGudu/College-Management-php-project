...
echo '<h4><a href="teacherpayment.html">Add Payment</a> | <a href="home.html">Back</a></h4><br>';
// Check connection
		...
		$sql = "SELECT id, regd_no,payment_method, amount, information FROM teacherpayment";
		...
		if ($result ->num_rows > 0) 
		{
		  ...
		  //  print_r($result->fetch_assoc()); exit;
		    ...
		    while($row = $result->fetch_assoc())
		     {
		        echo "<tr><td>" . $row["id"]. "</td><td>" . $row["regd_no"]. "</td><td>" . $row["payment_method"]. "</td><td>" . $row["amount"]. "</td><td>" . $row["information"]. "</td></tr>";
		   	 }
		    echo "</table>";
		} 
		else 
